...
export const tweetStore = defineStore("tweet", {
  ...
  actions: {
    addLike(id, fromUserId) {
      this[this.indexOf(id)].data.metrics.likeCount++;
      this[this.indexOf(id)].references.likesFrom.push(fromUserId);
    },
    removeLike(id, fromUserId) {
      this[this.indexOf(id)].data.metrics.likeCount--;
      this[this.indexOf(id)].references.likesFrom.splice(
        this[this.indexOf(fromUserId)],
        1
      );
    },
  },
